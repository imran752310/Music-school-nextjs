  ...
  return (
    <div className="p-12 bg-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 ">
          ...
          Enhance your muscial journey</p>
            </div>
            <div className="mt-10">
            ...
            <Link href={'/'} 
            className="px-4 py-2 rounded border border-neutral-600 text-neutral-700 bg-white hover:bg-gray-100 transition duration-200">View All Webinars</Link>
            </div>
        </div>
    </div>
  )
